...
static const void *image_list[NB_IMAGES] = {
    &klaus_112x85, &klaus_afraid_104x85, &klaus_bored_102x85, &klaus_dab_126x85,
    &klaus_fuck_100x85};
...
static void splash_view_draw(view_handler_t *_calling_view) {
  ...
  lv_obj_add_style(splash_view, style_get_background_main(), 0);
...
view_handler_t *splash_view_get_handler() { return &splash_view_handler; }
