...
static const void *image_list[WIFI_MENU_SIZE] = {&scan_85};

static const char *wifi_menu_texts[WIFI_MENU_SIZE] = {"SCAN"};
...
static void wifi_menu_view_draw(view_handler_t *_calling_view) {
  ...
  lv_obj_add_style(wifi_menu_view, style_get_background_main(), LV_PART_MAIN);
